...
App de administración para **SPICY Streetwear Co.**: inventario, compras, ventas (punto de venta) y finanzas, en una sola app que corre en web y Android desde el mismo código (Flutter).
